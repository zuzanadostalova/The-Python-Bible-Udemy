...
# 40. lesson - Travis
# adding info to the previous code
known_users = ["Ada", "Berthold", "Clementine", "Dominic", "Emmett", "Fin", "Geralt", "Hugh"]
...
while True:
    ...
    if name in known_users:
        ...
        if remove == "y":
            known_users.remove(name)
            # print(known_users) - control

        elif remove == "n":
            print("No problem, I did not want you to leave anyway.")

    else:
        print("Hmmm, I do not think I met you yet, {}.".format(name))
        ...
        # append just for this one round

# looped:
# Hello! My name is Travis.
# What is your name? Z
# Hmmm, I do not think I met you yet, Z.
